...
const speakersData = [
  ...
  { id: 11, name: 'Claire C John', role: 'Actress and Social Entrepreneur', img: import.meta.env.BASE_URL + 'Claire-C-John.jpeg', bio: 'Claire C. John is an actress and social entrepreneur known for her compelling performances in Malayalam cinema and her leadership at the KITES Foundation. Combining her career in entertainment with a deep commitment to social advocacy, she uses her platform to empower youth and champion human rights. She recently starred in the 2025 hit Detective Ujjwalan and continues to be a leading voice in Kerala’s development sector.' }
]
