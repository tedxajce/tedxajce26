...
const speakersData = [
  { id: 1, name: 'Divya S Iyer', role: 'IAS, Public Servant & Author', img: import.meta.env.BASE_URL + 'Divya-S-Iyer.jpg', bio: 'Divya S Iyer is a distinguished IAS officer serving Kerala. As Managing Director of Vizhinjam International Seaport and Director of Kerala Solid Waste Management Project, she drives impactful initiatives. Previously, she led as District Collector, Pathanamthitta, and Mission Director, Mahatma Gandhi NREGA. A doctor, author, and speaker, she bridges governance and innovation.' },
